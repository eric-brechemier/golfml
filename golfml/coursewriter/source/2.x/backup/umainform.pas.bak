...
==
== TODO:
== Option to make scorecard golfml
...
uses
  ...
  ugolfmlwriter_globals, ugolfmlclass,uwaitform,INIFiles,lclintf;
...
begin
    ...
    {$IFDEF WINDOWS}
            ...
            ConfigFilePath:='C:\GolfmlCourseWriter\GolfmlCourseWriter.cfg';
    {$ENDIF}
...
TRY
   ...
   If s='unknown' then
      begin
           {$IFDEF WINDOWS}
                   ForceDirectoriesUTF8('C:\GolfmlCourseWriter\');
                   dlg_open.InitialDir:='C:\GolfmlCourseWriter\';
           {$ENDIF}
           {$IFDEF LINUX}
                   ForceDirectoriesUTF8('/usr/share/doc/golfml');
                   dlg_open.InitialDir:='/usr/share/doc/golfml/';
           {$ENDIF}
      end
      else
