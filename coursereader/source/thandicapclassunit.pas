...
==
== TODO: 1 ) Write new subclass to read and parse GolfML XML course data and import it
==       into HCPClass pParArray, pCoursePar, pCourseRating and pSlopeRating //DONE
==       2 ) Extend to be able to produce a score card with Stableford score // TODO
==
== Purpose:
